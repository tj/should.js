...
Assertion.prototype = {
  ...
  /**
   * Checks if the properties of _object1_ are included in _object2_
   *
   * @param {Object} object1
   * @param {Object} object2
   * @api private
   */
  includesObject: function(object1, object2){
    var extracted = {};

    for (var property in object2){
      extracted[property] = object1[property];
    }

    return eql(extracted, object2);
  },
  ...
  include: function(obj, desc){
    if (obj.constructor == Object){
      this.assert(
          this.includesObject(this.obj, obj)
