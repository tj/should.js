...
Assertion.prototype = {
  ...
  get json() {
    ...
    this.assert(
      ok
      , function(){ return 'expected ' + this.inspect + ' to have content-type application/json'}
      , function(){ return 'expected ' + this.inspect + ' not to have content-type application/json'}
      , void 0
      , void 0);
    return this;
  },
  ...
  get html() {
    ...
    this.assert(
      ok
      , function(){ return 'expected ' + this.inspect + ' to have content-type text/html'}
      , function(){ return 'expected ' + this.inspect + ' not to have content-type text/html'}
      , void 0
      , void 0);
    return this;
  },
