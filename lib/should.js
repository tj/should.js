...
Assertion.prototype = {
  ...
  properties: function(originalNames) {
    ...
    if (typeof originalNames === 'object' && !(Array.isArray(originalNames))) {
      isNamesObj = true;
  ...
  keys: function(originalKeys){
    ...
    if (typeof originalKeys === 'object' && !(Array.isArray(originalKeys))) {
      isKeysObject = true;
