...
module.exports = function(should, Assertion) {
  ...
  Assertion.add('haveCss', function(css) {
    this.params = { operator: 'to have css ' + css };
    for (var prop in css) {
      var value = css[prop];
  ...
  Assertion.add('haveId', function(id) {
    ...
    this.assert($(this.obj).atr('id') == id);
  });
  ...
  Assertion.add('containElement', function(selector) {
    this.params = { operator: 'to contain selector ' + selector };
    this.assert($(this.obj).find(selector).length);
  });
