...
module.exports = function(should, Assertion) {
  ...
  var collectResults = function (obj, method, keyOrHash) {
    var keys = util.isObject(keyOrHash) ? Object.keys(keyOrHash) : [keyOrHash];
    return keys.reduce(function (memo, key) {
      var value = $(obj)[method](key);
  ...
  function jQueryAttributeTestHelper(method, singular, plural, nameOrHash, value) {
    var allRelevantAttributes = collectResults(this.obj, method, nameOrHash);
